@extends('layouts.app')
@section('title', 'Edit Resume - Jobs.AF')
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-up-muted mt-0.5">Update your professional resume</p>
            </div>
        </div>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 py-8">
    <form action="{{ route('resume.update', $resume->id) }}" method="POST">
        ...
        <div class="bg-white border border-up-border rounded-2xl p-6 mb-6">
            ...
            <div class="mb-5">
                ...
                <textarea name="summary" rows="4"
                          ...
                          placeholder="Write a brief, compelling summary of your professional background and goals...">{{ old('summary', $resume->summary) }}</textarea>
                @error('summary')
                <p class="text-red-500 text-sm mt-1"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="bg-white border border-up-border rounded-2xl p-6 mb-6">
            ...
            <p id="exp-empty-msg" class="text-up-muted text-sm text-center py-4" style="display:none;">
        ...
        <div class="bg-white border border-up-border rounded-2xl p-6 mb-6">
            ...
            <p id="edu-empty-msg" class="text-up-muted text-sm text-center py-4" style="display:none;">
        ...
        <div class="bg-white border border-up-border rounded-2xl p-6 mb-6">
            ...
            <p id="lang-empty-msg" class="text-up-muted text-sm text-center py-4" style="display:none;">
        ...
        <div class="flex gap-4 flex-wrap">
            ...
            <a href="{{ route('resume.view', $resume->id) }}"
               class="btn-dark px-8 py-3 font-medium flex items-center gap-2">
...
{{-- Pre-existing resume data passed safely as JSON for pre-fill --}}
<script>
var resumeData = {
    experience: @json($resume->experience ?? []),
    education:  @json($resume->education  ?? []),
    languages:  @json($resume->languages  ?? [])
};
</script>
...
(function () {
    ...
    // Pre-fill existing data on page load
    (resumeData.experience || []).forEach(function (e) { addExperience(e); });
    (resumeData.education  || []).forEach(function (e) { addEducation(e); });
    (resumeData.languages  || []).forEach(function (e) { addLanguage(e); });
}());
</script>
